...
[ \t\f]*        /* plain whitespace -- ignore it and keep looping */;

"*DiSaBlEd"[\n\r][ \t\f]*  { /* a newline plus some possible leading white space - record this to reconstruct formatting with */
...
"("{white}[^)]*")"/{white}   { token.type = COMMENT; token.text = yytext;
				return &token; }
